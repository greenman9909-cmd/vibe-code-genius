...
Before marking complete: python scripts/validate-artifact.py security-verify.json schema/security_report.schema.json. If validation fails, halt. Do not mark complete.
