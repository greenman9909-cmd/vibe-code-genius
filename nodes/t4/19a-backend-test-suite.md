...
Before marking complete: python scripts/validate-artifact.py backend-test-report.json schema/node.schema.json. If validation fails, halt. Do not mark complete.
