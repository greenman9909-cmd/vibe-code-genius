...
Before marking complete: python scripts/validate-artifact.py --node 19a --artifact backend-test-report.json --schema schema/backend-test-report.schema.json. If validation fails, halt. Do not substitute a different artifact. Do not continue.
