...
Before marking complete: python scripts/validate-artifact.py backend-test-report.json schema/backend-test-report.schema.json. If validation fails, halt. Do not mark complete.
