...
Before marking complete: python scripts/validate-artifact.py migration-strategy.md schema/node.schema.json. If validation fails, halt. Do not mark complete.
