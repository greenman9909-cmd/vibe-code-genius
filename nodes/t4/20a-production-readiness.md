...
Before marking complete: python scripts/validate-artifact.py production_checklist.json schema/production_checklist.schema.json. If validation fails, halt. Do not mark complete.
