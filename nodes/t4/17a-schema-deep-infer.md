...
Before marking complete: python scripts/validate-artifact.py schema-deep.json schema/schema-deep.schema.json. If validation fails, halt. Do not mark complete.
