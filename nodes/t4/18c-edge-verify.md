...
Before marking complete: python scripts/validate-artifact.py edge-report.json schema/edge-report.schema.json. If validation fails, halt. Do not mark complete.
