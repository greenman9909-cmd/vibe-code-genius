...
Before marking complete: python scripts/validate-artifact.py api-deployment.md schema/api-deployment.schema.json. If validation fails, halt. Do not mark complete.
