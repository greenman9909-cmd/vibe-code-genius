...
Before marking complete: python scripts/validate-artifact.py deploy-hardening.md schema/deploy-hardening.schema.json. If validation fails, halt. Do not mark complete.
