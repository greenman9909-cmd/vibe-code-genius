...
Before marking complete: python scripts/validate-artifact.py security-report.json schema/security_report.schema.json. If validation fails, halt. Do not mark complete.
