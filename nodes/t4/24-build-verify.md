...
Before marking complete: python scripts/validate-artifact.py build-report.json schema/build-report.schema.json. If validation fails, halt. Do not mark complete.
