...
Before marking complete: python scripts/validate-artifact.py design-commitment.md schema/node.schema.json. If validation fails, halt. Do not mark complete.
