...
Before marking complete: python scripts/validate-artifact.py style-rules.md schema/style-rules.schema.json. If validation fails, halt. Do not mark complete.
