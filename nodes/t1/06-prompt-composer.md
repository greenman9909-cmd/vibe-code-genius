...
Before marking complete: python scripts/validate-artifact.py prompt.md + handoff.md schema/node.schema.json. If validation fails, halt. Do not mark complete.
