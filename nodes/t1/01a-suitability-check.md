...
Before marking complete: python scripts/validate-artifact.py suitability.json schema/suitability.schema.json. If validation fails, halt. Do not mark complete.
