...
Before marking complete: python scripts/validate-artifact.py --node 01d --artifact system.json --schema schema/system.schema.json. If validation fails, halt. Do not substitute a different artifact. Do not continue.
