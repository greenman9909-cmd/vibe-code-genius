...
Before marking complete: python scripts/validate-artifact.py --node 12b --artifact static-report.json --schema schema/static-report.schema.json. If validation fails, halt. Do not substitute a different artifact. Do not continue.
