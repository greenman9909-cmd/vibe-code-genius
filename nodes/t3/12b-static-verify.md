...
Before marking complete: python scripts/validate-artifact.py static-report.json schema/static-report.schema.json. If validation fails, halt. Do not mark complete.
