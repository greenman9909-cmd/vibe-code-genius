...
Before marking complete: python scripts/validate-artifact.py runtime-report.json schema/runtime-report.schema.json. If validation fails, halt. Do not mark complete.
