...
Before marking complete: python scripts/validate-artifact.py motion-layer.md schema/motion-layer.schema.json. If validation fails, halt. Do not mark complete.
