...
Before marking complete: python scripts/validate-artifact.py consistency-report.json schema/consistency-report.schema.json. If validation fails, halt. Do not mark complete.
