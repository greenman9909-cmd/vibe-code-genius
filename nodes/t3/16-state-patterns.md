...
Before marking complete: python scripts/validate-artifact.py state-model.md schema/state-model.schema.json. If validation fails, halt. Do not mark complete.
