...
Tier: 3  Prereqs: [09, 10, 12, 11b]  Parallel with: [13a, 14, 15, 16]  Input: routes + sections + component kit + copy cleanse  Output: pages/index.tsx  Model: sonnet  Budget: 5000 tokens
...
2. Inspect the input and extract only facts relevant to route builder.
3. Produce `pages/` with deterministic ordering, explicit nulls, and no invented evidence.
