...
Before marking complete: python scripts/validate-artifact.py stack-decision.md schema/stack-decision.schema.json. If validation fails, halt. Do not mark complete.
