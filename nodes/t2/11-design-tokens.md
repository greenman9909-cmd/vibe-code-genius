...
Before marking complete: python scripts/validate-artifact.py design-tokens.json schema/tokens.schema.json. If validation fails, halt. Do not mark complete.
