...
Before marking complete: python scripts/validate-artifact.py design_system.json schema/design-tokens.schema.json. If validation fails, halt. Do not mark complete.
