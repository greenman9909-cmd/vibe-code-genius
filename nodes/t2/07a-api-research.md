...
Before marking complete: python scripts/validate-artifact.py api_research.json schema/api_research.schema.json. If validation fails, halt. Do not mark complete.
