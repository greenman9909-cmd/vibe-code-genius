...
Before marking complete: python scripts/validate-artifact.py slop-lint.json schema/slop-report.schema.json. If validation fails, halt. Do not mark complete.
