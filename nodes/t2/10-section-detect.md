...
Before marking complete: python scripts/validate-artifact.py sections.md + sections.json schema/node.schema.json. If validation fails, halt. Do not mark complete.
