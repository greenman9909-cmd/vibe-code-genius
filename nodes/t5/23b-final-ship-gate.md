...
Before marking complete: python scripts/validate-artifact.py ship-report.json schema/ship-report.schema.json. If validation fails, halt. Do not mark complete.
