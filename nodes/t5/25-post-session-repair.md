...
Before marking complete: python scripts/validate-artifact.py repair-report.json schema/repair-report.schema.json. If validation fails, halt. Do not mark complete.
