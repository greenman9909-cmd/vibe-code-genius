...
Before marking complete: python scripts/validate-artifact.py multi-agent-report.json schema/multi-agent-report.schema.json. If validation fails, halt. Do not mark complete.
