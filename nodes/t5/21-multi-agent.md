...
Before marking complete: python scripts/validate-artifact.py multi-agent-report.json schema/node.schema.json. If validation fails, halt. Do not mark complete.
